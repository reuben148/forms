    ...
    <div className="border w-[90%] sm:w-[80%] max-w-[550px] h-auto mx-auto my-10 flex justify-center items-start p-4 sm:p-6 rounded-lg shadow-lg">
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:justify-center">
          <div className="border w-[150px] h-[150px] rounded-[10px] p-2">
            <i className="fa-solid fa-gamepad fa-2x text-orange-300"></i>
          ...
          <div className="border w-[150px] h-[150px] rounded-[10px] p-2">
            <i className="fa-solid fa-puzzle-piece fa-2x text-orange-300"></i>
            <div className="mt-[45px]">
        ...
        <div className="border h-[40px] w-full mt-5 rounded-[10px] flex justify-around items-center bg-slate-100">
